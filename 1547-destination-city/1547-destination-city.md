<h1>1547 - Destination City</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/destination-city/">destination-city</a></h2><p>You are given the array <code>paths</code>, where <code>paths[i] = [cityA<sub>i</sub>, cityB<sub>i</sub>]</code> means there exists a direct path going from <code>cityA<sub>i</sub></code> to <code>cityB<sub>i</sub></code>. <em>Return the destination city, that is, the city without any path outgoing to another city.</em></p>
