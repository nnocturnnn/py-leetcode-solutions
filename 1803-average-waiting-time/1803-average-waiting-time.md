<h1>1803 - Average Waiting Time</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/average-waiting-time/">average-waiting-time</a></h2><p>There is a restaurant with a single chef. You are given an array <code>customers</code>, where <code>customers[i] = [arrival<sub>i</sub>, time<sub>i</sub>]:</code></p>
