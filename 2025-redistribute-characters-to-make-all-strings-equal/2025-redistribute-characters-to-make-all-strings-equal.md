<h1>2025 - Redistribute Characters to Make All Strings Equal</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/redistribute-characters-to-make-all-strings-equal/">redistribute-characters-to-make-all-strings-equal</a></h2><p>You are given an array of strings <code>words</code> (<strong>0-indexed</strong>).</p>
